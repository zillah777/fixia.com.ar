...
export default function EditOpportunityPage() {
  ...
  useEffect(() => {
    const loadOpportunity = async () => {
      ...
      try {
        setLoading(true);
        const { opportunitiesService: oppService } = await import('../lib/services/opportunities.service');
        const opportunity = await oppService.getProjectById(id);
        ...
        if (opportunity) {
          setFormData({
            ...
            budget_max: opportunity.budget_max || 0,
  ...
  const handleUpdate = async () => {
    ...
    setUpdating(true);
    try {
      const opportunityData: Partial<CreateOpportunityData> = {
      ...
      await opportunitiesService.updateProject(id, opportunityData);
      ...
      const errorMessage = error?.response?.data?.message || error?.message || "Error al actualizar el anuncio";
          ...
          <Card className="glass border-white/10">
            ...
            <CardContent className="space-y-6">
              ...
              <Alert className="border-primary/20 bg-primary/5">
                ...
                <AlertDescription>
                  <strong className="text-primary">Nota:</strong> Los cambios se guardarán inmediatamente. Los profesionales verán la versión actualizada de tu anuncio.
                </AlertDescription>
              </Alert>
